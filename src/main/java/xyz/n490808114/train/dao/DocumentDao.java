...
public interface DocumentDao {
        ...
        @Results(id = "documentResult",value = { @Result(id = true, column = "id", property = "id"), @Result(column = "title", property = "title"),
                        @Result(column = "filename", property = "fileName"),
                        @Result(column = "remark", property = "remark"),
                        @Result(column = "create_date", property = "createDate"),
                        @Result(column = "id", property = "user", one = @One(select = "xyz.n490808114.dao.UserDao.selectById", fetchType = FetchType.EAGER)) })
