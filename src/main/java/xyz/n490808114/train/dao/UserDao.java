...
public interface UserDao {
    ...
    @Select("select * from user_inf where email = #{email} and password = #{password}")
    @ResultMap("userResult")
    ...
    @Select("select count(id) from user_inf where email = #{email}")
    int registerCheckEmail(@Param("email") String email);
